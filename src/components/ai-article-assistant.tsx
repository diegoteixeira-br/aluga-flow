...
export function AiArticleAssistant({
  ...
  onArticleReady: (a: GeneratedArticle) => void;
}) {
        ...
        <div className="flex-1 space-y-4 overflow-y-auto px-6 py-4">
          <div>
            ...
            <p className="mt-1 text-xs text-muted-foreground">
              Deixe em branco para receber temas variados sobre o mercado imobiliário.
            </p>
          </div>
          ...
          {suggestions.length > 0 && (
            <div className="space-y-2">
                  ...
                  >
                    ...
                    >
                      {generatingIdx === i ? (
                        ...
                        <>
                          <Wand2 className="mr-1 h-4 w-4" /> Gerar
                        </>
                      )}
                    </Button>
                  </li>
              ...
              <p className="text-xs text-muted-foreground">
                A geração leva alguns segundos. O artigo abrirá no editor como rascunho para você
