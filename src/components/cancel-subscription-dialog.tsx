...
const REASONS = ["Preço alto", "Não uso mais", "Encontrei outra solução", "Outro"];
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            Você voltará para o plano Gratuito ao fim do período atual
            {periodEnd ? ` (${formatDate(periodEnd)})` : ""}. Seus dados ficam salvos, mas o acesso
            aos recursos pagos será removido.
          </DialogDescription>
        </DialogHeader>
        <div className="space-y-3 py-2">
          ...
          <div className="space-y-1">
            ...
            <Textarea
              ...
              placeholder="Conte mais para nos ajudar a melhorar..."
            />
          </div>
        </div>
        <DialogFooter>
