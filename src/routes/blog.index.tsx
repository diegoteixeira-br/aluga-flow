  ...
  head: () => ({
    meta: [
      { title: "Blog AlugaFlow — Notícias do mercado imobiliário" },
      {
        name: "description",
        content:
          "Artigos, dicas e novidades sobre o mercado imobiliário em Cáceres-MT e no Brasil.",
      },
      ...
      <main className="mx-auto max-w-6xl px-4 py-10">
        <div className="mb-8">
          ...
          <p className="mt-2 text-muted-foreground">
            Notícias e dicas sobre o mercado imobiliário.
          </p>
        </div>
        {posts.length === 0 ? (
              ...
              >
                ...
                <div className="p-4">
                  ...
                  <p className="mt-3 text-xs text-muted-foreground">
                    {formatDateBR(p.created_at)} • {readingTime(p.excerpt)} min de leitura
                  </p>
                </div>
              </Link>
            ))}
