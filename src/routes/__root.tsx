...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "https://alugaflow.com.br/og-image.png" },
      { property: "og:image:secure_url", content: "https://alugaflow.com.br/og-image.png" },
      ...
      { name: "twitter:image", content: "https://alugaflow.com.br/og-image.png" },
    ],
    links: [
