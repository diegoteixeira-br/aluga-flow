  ...
  head: () => ({
    meta: [
      { title: "AlugaFlow | Sistema de Gestão de Aluguéis e Imóveis" },
      {
        name: "description",
        content:
          "Gestão de inquilinos, contratos de aluguel automáticos, cobrança integrada (PIX e boleto) e controle financeiro completo para proprietários e imobiliárias. Anuncie grátis e gerencie tudo em um só lugar.",
      },
      {
        name: "keywords",
        content:
          "gestão de aluguéis, gestão de inquilinos, contratos de aluguel automáticos, cobrança integrada, controle financeiro imobiliário, software para imobiliária, sistema para proprietários",
      },
      { property: "og:title", content: "AlugaFlow | Sistema de Gestão de Aluguéis e Imóveis" },
      {
        property: "og:description",
        content:
          "Gestão de inquilinos, contratos automáticos, cobrança integrada e controle financeiro para proprietários e imobiliárias.",
      },
      ...
      { name: "twitter:title", content: "AlugaFlow | Sistema de Gestão de Aluguéis e Imóveis" },
      {
        ...
        content:
          "Gestão de inquilinos, contratos automáticos, cobrança integrada e controle financeiro.",
      },
    ],
...
function Landing() {
  useAuth();
  const { data } = useQuery({
    queryKey: ["latest-posts-carousel"],
      ...
      <section className="border-t bg-gradient-to-br from-primary/10 via-background to-background py-12">
        <div className="mx-auto max-w-4xl px-4 text-center">
          <p className="text-xs font-semibold uppercase tracking-wider text-primary">
            É proprietário ou imobiliária?
          </p>
          <h2 className="mt-2 text-2xl font-bold tracking-tight md:text-3xl">
            Conheça o AlugaFlow por dentro
          </h2>
          <p className="mx-auto mt-3 max-w-xl text-muted-foreground">
            Anuncie grátis, gerencie contratos, cobranças e relatórios em um só lugar.
          </p>
          <div className="mt-6">
            <a
            ...
            <div className="flex items-end justify-between">
              <div>
                ...
                <p className="mt-1 text-sm text-muted-foreground">
                  Mercado imobiliário, dicas e novidades.
                </p>
              </div>
                ...
                {latest.map((p) => (
                  <CarouselItem key={p.id} className="pl-4 sm:basis-1/2 lg:basis-1/3">
                    <Link
                      to="/blog/$slug"
                      params={{ slug: p.slug }}
                      className="group block h-full overflow-hidden rounded-lg border bg-card transition hover:shadow-md"
                    >
                      {p.cover_image_url && (
